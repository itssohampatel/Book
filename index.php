...
<body>
	<header>
		<div onclick="opac()" id="namediv">
			<img src="http://jeet.shreekhodiyarind.co.in/soham/Books/img/profile.png" width="40px" height="33px"/>
	...
	<div id="sidebar">
		...
		<hr class="firsthr"/>
		<img src="http://jeet.shreekhodiyarind.co.in/soham/Books/img/profile.png" width="70" height="43" />
	...
	<script type="text/javascript">
		...
		$('#headerbtns').click(function(){
            var cuki = "key1=; expires="+new Date(new Date().getTime()-100).toGMTString()+"; path=/soham/Books/;";
		...
		$('#sidemenu div').click(function(){
			...
			document.myfrm.location.replace("html/"+($('span',this).html()).replace(/\s/g,"")+".html?x=1");
		});
